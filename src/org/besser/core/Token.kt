...
val Keywords = arrayOf("print", "read", "fun", "elem", "of", "self", "then", "end", "get", "set", "as", "import", "if", "else", "while", "when", "book", "for", "event", "repeat", "until", "on", "size", "isolated", "try", "except", "chan", "NUM", "STR", "BOOL", "ELEM", "ARRAY", "CHANNEL", "JBYTE", "JSHORT", "JINT", "JLONG", "JFLOAT", "JDOUBLE", "JNULL")
val Keywords_Name = arrayOf("PRINT", "READ", "FUN", "ELEM", "OF", "SELF", "THEN", "END", "GET", "SET", "AS", "IMPORT", "IF", "ELSE", "WHILE", "WHEN", "BOOK", "FOR", "EVENTK", "REPEAT", "UNTIL", "ON", "SIZE", "ISOLATED", "TRY", "EXCEPT", "CHAN", "NUMT", "STRT", "BOOLT", "ELEMT", "ARRAYT", "CHANT", "JBYTET", "JSHORTT", "JINTT", "JLONGT", "JFLOATT", "JDOUBLET", "JNULLT")
